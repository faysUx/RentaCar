...
class RegistrationController extends AbstractController
{
    ...
    public function adminMembre(Request $globals, MemberRepository $repo, EntityManagerInterface $manager, UserPasswordHasherInterface $userPasswordHasher, Member $membre = null)
    {
        $colonnes =$manager->getClassMetadata(Member::class)->getFieldNames();
    ...
    public function deleteArticle(Member $membre, EntityManagerInterface $manager)
    {
